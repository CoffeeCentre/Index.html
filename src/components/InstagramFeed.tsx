...
// lucide-react v1.14.0 pinned in this project doesn't export `Instagram`.
// Inline SVG (Instagram-style camera glyph — square with rounded corners,
// lens circle, shutter dot) — draws in currentColor so classes control tint.
